...
def main(json_path='options/train_dncnn.json'):
    ...
    # ----------------------------------------
    '''
    opt['train']['checkpoint_print'] = 5
    opt['train']['checkpoint_save'] = 10

    print("Checkpoint epoch = ", opt['train']['checkpoint_print'])
    print("Save Checkpoint epoch = ", opt['train']['checkpint_save'])

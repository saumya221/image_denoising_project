...
for level = 1:1:J
    ...
    Atemp = ICol(1:S(1,1), 1:S(1,2));
    Htemp = ICol(1:S(1,1), S(1,2)+1:S(2,2));
    Vtemp = ICol(S(1,1)+1:S(2,1), 1:S(1,2));
    Dtemp = ICol(S(1,1)+1:S(2,1), S(1,2)+1:S(2,2));
    ...
    wc(1:S(1,1), 1:S(1,2)) = Atemp;
    wc(1:S(1,1), S(1,2)+1:S(2,2)) = Htemp;
    wc(S(1,1)+1:S(2,1), 1:S(1,2)) = Vtemp;
    wc(S(1,1)+1:S(2,1), S(1,2)+1:S(2,2)) = Dtemp;
